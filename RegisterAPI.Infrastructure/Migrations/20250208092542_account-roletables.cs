...
{
    /// <inheritdoc />
    public partial class accountroletables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CHK_TransactionType", "TransactionType IN ('Deposit', 'Withdrawal', 'Transfer')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    RoleEnityModelRoleId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoles", x => x.UserRoleId);
                    table.ForeignKey(
                        name: "FK_UserRoles_Roles_RoleEnityModelRoleId",
                        column: x => x.RoleEnityModelRoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_RoleEnityModelRoleId",
                table: "UserRoles",
                column: "RoleEnityModelRoleId");
